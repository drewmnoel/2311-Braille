...
public class SimulatorCoreTest {
	...
	/**
	 * Tests clearCells() clears all cells to 0 after being assigned other
	 * values
	 *
	 * @throws SimulatorException
	 *             If the simulator core enters an invalid state
	...
	public void testCellAt() throws SimulatorException {
		...
		for (int i = 0; i < testSim.numOfCells(); i++) {
			for (int j = 0; j < 8; j++) {
				int temp = testSim.cellAt(i)[j];
				if (i != 1) {
					assertEquals(0, temp); // Test other cells are unchanged,
											// still 0
	...
	public void testAllCells() throws SimulatorException {
		...
		ArrayList<int[]> testList1 = new ArrayList<>();
		ArrayList<int[]> testListExpected = new ArrayList<>();
	...
	/**
	 * Tests that setCell() throws the proper exception for an invalid cell
	 * number
	 *
	 * @throws SimulatorException
	 *             If the simulator core enters an invalid state
	...
	/**
	 * Tests that setCell() throws the proper exception for a non-8 element
	 * array
	 *
	 * @throws SimulatorException
	 *             If the simulator core enters an invalid state
	...
	/**
	 * Tests that cellAt() throws the proper exception for an invalid cell
	 * number
	 *
	 * @throws SimulatorException
	 *             If the simulator core enters an invalid state
	...
	public void testMutlipleCellsGetAndSet() throws SimulatorException {
		...
		// Set cell 0 for SimCore with 1 cell, set cell 1 for SimCore with 2
		// cells, etc.
		for (int i = 0; i < 10; i++) {
	...
	/**
	 * Test that trying to use setCell() with an array with values other than 0
