...
public class BrailleTextTranslator {
	...
	/**
	 * Convert string input to array of Braille cells. Only supports translation
	 * of lower case alphabet characters. For all other characters use the
	 * setCell() method in the SimulatorCore class to set the cell pins
	 * directly.
	 *
	 * @param input
	 *            String of text to convert into Braille cells. Must only
