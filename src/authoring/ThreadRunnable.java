...
public class ThreadRunnable extends Thread {
	 ...
	 */
	public ThreadRunnable(String fileName) {
		// Define the audio format to be WAVE audio, Microsoft PCM, 16 bit, stereo 44100 Hz
	...
	public void start() {
		...
		// Now call Thread's start (which triggers ThreadRunnable's run() for us)
		super.start();
	}
	...
	public void stopRecording() {
		// Stop the line and then close it. The recorder will drain the line itself.
		line.stop();
		line.close();
	}
